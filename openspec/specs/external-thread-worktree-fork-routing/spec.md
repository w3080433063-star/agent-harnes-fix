# external-thread-worktree-fork-routing Specification

## Purpose

Define ownership-safe external Fork routing into a Desktop-provisioned target cwd without making codexhost responsible for Git Worktree lifecycle.
