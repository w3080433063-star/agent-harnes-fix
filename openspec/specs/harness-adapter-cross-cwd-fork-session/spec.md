# harness-adapter-cross-cwd-fork-session Specification

## Purpose

Define caller-selected cwd Fork capability and derived execution-location semantics without assigning Git Worktree lifecycle to HarnessAdapter.
