...
This slice SHALL add only ordinary Tool permission Approval and exact response conversion. It SHALL NOT add Permission Mode control, automatic approval, codexhost-owned permission rules, Tool Item mapping, File Change mapping, Diff inference, Tool history, or custom Renderer UI.
